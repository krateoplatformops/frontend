...
### Fixed
- Fixed `LineChart` displaying

## [1.0.20] - 2026-04-21

### Added
- Added links handling and content optional vertical scroll to `Markdown`

### Fixed
- Fixed code blocks displaying in `Markdown`
...
### Fixed
- Fixed access token retrieval after refreshing

## [1.0.17] - 2026-04-08

### Changed
- Updated login and logout logic
