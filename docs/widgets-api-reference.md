...
| dependencies[].extra | no | parameter to be added to the RESTAction call | object |
...
| dependencies[].resourceRefId | no | the identifier of the RESTAction that should be called to retrieve dependency data | string |
