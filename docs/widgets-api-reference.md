...
| autocomplete[].fetch.queryParam | no | The query parameter to be appended to the base URL to call the API | string |
...
| dependencies[].fetch.queryParam | no | The query parameter to be appended to the base URL to call the API | string |
